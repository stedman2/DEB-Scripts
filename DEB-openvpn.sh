...
#  change to openvpn at some stage...
...
# enter info - remember AU VI Melb ...


 


# run ? dunno here k... might not need yo
# openvpn /etc/openvpn/1194-udp.conf &


#  not sure if will work after reboot but all good coz works atm
